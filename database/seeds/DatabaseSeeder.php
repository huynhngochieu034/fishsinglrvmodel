...
class adminSeeder extends Seeder{
    public function run(){
        DB::table('tbl_admin')->insert([
          ...
          ['category_name' => 'Thuốc Cho Cá','category_desc'=>'Phụ kiện','category_status' => '0'],
          ...
          ['product_name' => 'Cá chuột ngọc trai','category_id'=>'10','brand_id' => '1', 'product_desc'=>'Cá Chuột Ngọc Trai – Emerald Green Cory Cat – Brochis splendens', 'product_content'=>'Cá Chuột Ngọc Trai giúp cho đáy của bể cá nhà bạn thêm phần sinh động. Loài cá ăn tầng đáy này có một cơ thể màu ngọc bích óng ả với phần bụng hơi hồng. Ngoài việc trang trí cho hồ cá thêm hấp dẫn hơn, cá Chuột Ngọc Trai còn giúp loại bỏ thức ăn thừa nơi đáy bể, giúp bể cá sạch sẽ hơn.', 'product_price'=>'1300000', 'product_image'=>'cachuot.jpg', 'product_stock'=>'10', 'product_status' => '0'],
           ...
           ['product_name' => 'Cá Hoàng Bảo Yến Hoa','category_id'=>'11','brand_id' => '1', 'product_desc'=>'Cá Hoàng Bảo Yến Hoa Kelberi size 18cm', 'product_content'=>'Cá Hoàng Bảo Yến Hoa Kelberi là một trong những loại cá săn mồi độc đáo, chúng thường được thả trong bể săn mồi cùng với cá rồng, cá hổ, sá sam, hoặc thả theo đàn cũng vô cùng ấn tượng. Sở hữu màu vàng rực rỡ với những hoa văn cuốn hút, Hoàng Bảo Yến  Hoa Kelberi là một trong những loại cá săn mồi được yêu thích nhất.', 'product_price'=>'2400000', 'product_image'=>'baoyen.jpg', 'product_stock'=>'10','product_status' => '0'],
          ...
          ['product_name' => 'Cá hề','category_id'=>'12','brand_id' => '1', 'product_desc'=>'Cá Hề – cá Khoang Cổ – Saddleback Clownfish- Amphiprion polymunus', 'product_content'=>'Cá Hề Saddleback là một trong những loài cá cảnh biển phổ biến nhất trên thế giới, được lựa chọn để thả trong những bể chứa nhiều san hô mềm, chúng khá khỏe mạnh và dễ thương khi xuất hiện bên cạnh những con san hô. Cá Hề thường được tìm thấy ở phía Tây Thái Bình Dương, Trung Quốc, Việt Nam, Đài Loan, phía nam Indonesia, Philippines, Australia, phía tây New Guinea và quần đảo Soloman. Loài cá này có tính khí tương tự như những con cá Hề Sebae hoặc cá Hề Clarkii, nên nuôi chúng theo những nhóm nhỏ hay thành từng cặp trong thời gian sinh sản. Những con cá Hề này dường như sinh ra để làm cảnh, những con cá Hề trong bể dường như có khả năng thích nghi cao hơn cả những con cá ngoài hoang dã, tuy nhiên cả hai đều rất dễ chăm sóc.', 'product_price'=>'1400000', 'product_image'=>'cahe.jpg', 'product_stock'=>'10','product_status' => '0'],
           ...
           ['product_name' => 'Cá kiếm','category_id'=>'11','brand_id' => '1', 'product_desc'=>'Cá Kiếm – cá Khoang Cổ – Saddleback Clownfish- Amphiprion polymunus', 'product_content'=>'Cá Kiếm Saddleback là một trong những loài cá cảnh biển phổ biến nhất trên thế giới, được lựa chọn để thả trong những bể chứa nhiều san hô mềm, chúng khá khỏe mạnh và dễ thương khi xuất hiện bên cạnh những con san hô. Cá Hề thường được tìm thấy ở phía Tây Thái Bình Dương, Trung Quốc, Việt Nam, Đài Loan, phía nam Indonesia, Philippines, Australia, phía tây New Guinea và quần đảo Soloman. Loài cá này có tính khí tương tự như những con cá Hề Sebae hoặc cá Hề Clarkii, nên nuôi chúng theo những nhóm nhỏ hay thành từng cặp trong thời gian sinh sản. Những con cá Hề này dường như sinh ra để làm cảnh, những con cá Hề trong bể dường như có khả năng thích nghi cao hơn cả những con cá ngoài hoang dã, tuy nhiên cả hai đều rất dễ chăm sóc.', 'product_price'=>'140000', 'product_image'=>'cakiem.jpg', 'product_stock'=>'10','product_status' => '0'],
          ...
          ['product_name' => 'Thức ăn cá Ali – Hikari Cichlid Gold 250g (Tăng màu)','category_id'=>'4','brand_id' => '2', 'product_desc'=>'Thức ăn cá Ali – Hikari Sinking Cichlid Excel 342g', 'product_content'=>'Đây là một loại thức ăn cân bằng, các thành phần dinh dưỡng của nó phù hợp với nhu cầu của  ngay cả các loại cá ăn thực vật. Hương vị tuyệt vời của nó làm hài lòng cả những con cá khó tính nhất.
           ...
           ['product_name' => 'Máy bơm điện 1 chiều Chaning CN China (300)','category_id'=>'1','brand_id' => '2', 'product_desc'=>'Máy bơm Chaning CN 8100 thực sự là một series quá chất lượng so với các sản phẩm máy bơm nước bể cá trên thị trường hiện nay.', 'product_content'=>'Thiết kế máy đẹp, chắc chắn, được sản xuất từ nhựa cao cấp, giúp máy bền hơn rất nhiều.
          ...
          ['product_name' => 'Bể cá rồng gỗ Hương','category_id'=>'5','brand_id' => '3', 'product_desc'=>'Mẫu bể cá cảnh cao cấp với hệ thống lọc chuyên nghiệp thường được dùng để nuôi cá rồng, một loại cá cảnh bá vương nhất trong các loại cá cảnh.', 'product_content'=>'Bể cá cảnh cao cấp được dùng nuôi cá rồng thường rất chú trọng chiều rộng, để con cá có thể thong dong quay đầu, không bị giật cục, gây cảm giác tức mắt cho người ngắm chơi. Trong hình là bể có kích thước 158x69x81, chân cao 75cm, Khung Lim – Vỏ Hương, mẫu cột tiện, cánh đục chữ thọ. Với các trang thiết bị và hệ thống lọc chuyên nghệp dành để nuôi cá rồng Huyết Long.', 'product_price'=>'1300000', 'product_image'=>'becahuong.jpg', 'product_stock'=>'10', 'product_status' => '0'],
           ...
           ['product_name' => 'Thuốc khử Clo cho nước mới','category_id'=>'13','brand_id' => '2', 'product_desc'=>'Dùng để khử clo,  mùi thuốc tẩy trong nước máy.', 'product_content'=>'Dùng để khử clo,  mùi thuốc tẩy trong nước máy.
1 giọt thuốc khử nước 2lit nước máy.
Cho thuốc vào nước mới trộn đều hoặc bật sủi, lọc trong 20 phút. Sau đó cho cá vào.
Khi thay nước cho bể cá cần cho thuốc theo tỉ lệ phù hợp với lượng nước mới cho vào.', 'product_price'=>'20000', 'product_image'=>'clo.jpg', 'product_stock'=>'10','product_status' => '0'],

          ['product_name' => 'Thuốc đặc trị nấm cho cá cảnh BIO-KNOCK','category_id'=>'13','brand_id' => '2', 'product_desc'=>'Thuốc đặc trị nấm cao cấp cho cá cảnh BIO-KNOCK Số 2 của Thái Lan', 'product_content'=>'Thuốc đặc trị nấm cao cấp cho cá cảnh BIO-KNOCK Số 2 của Thái Lan là loại thuốc trị nấm và các mầm nấm rất nhạy. Nó có tác dụng chữa bệnh tất cả các loại nấm cho cá như nấm trắng, nâm thân. Đặc biệt nhất là sát trùng cho cá, dùng hiệu quả cho các loại cá cảnh như: Guppy, Betta, La Hán, …', 'product_price'=>'45000', 'product_image'=>'thuoctim.jpg', 'product_stock'=>'10', 'product_status' => '0'],

           ['product_name' => 'Thuốc trị nấm Bensol probio','category_id'=>'13','brand_id' => '2', 'product_desc'=>'Bensol đặt trị nấm và ký sinh trùng cho cá cảnh.', 'product_content'=>'Tiêu diệt các loại nấm ký sinh trên mình cá rồng, cá chép Koi, các loại cá cảnh khác.
Trị các loại ký sinh trùng sống ký sinh trong mang cá, trên da cá và vây cá gây cách bệnh như: bệnh nấm da, nấm miệng, bệnh đốm trắng, trùng mỏ neo bám trên người, rận nước bám trong mang cá.
Ngoài ra thuốc còn có chức năng phòng bệnh cho cá mới mua trước khi thả vào hồ, sát khuẩn cho cá mồi trước khi cho cá rồng ăn. Liều dùng 2 giọt/ lít nước trong 30 phút.', 'product_price'=>'20000', 'product_image'=>'bensol.jpg', 'product_stock'=>'10','product_status' => '0'],

          ['product_name' => 'Thuốc tím TN Sát trùng – Diệt khuẩn
','category_id'=>'13','brand_id' => '2', 'product_desc'=>'Thuốc tím (KMnO4) thường được sử dụng để sát khuẩn, khử trùng cá mới trước khi thả vào hồ.', 'product_content'=>'Thuốc tím (KMnO4) thường được sử dụng để sát khuẩn, khử trùng cá mới trước khi thả vào hồ, thuốc tím có công dụng đốt cháy hóa học các thành phần hữu cơ như vi trùng, nấm và các khuẩn gây bệnh cho cá khi sử dụng đúng liều lượng
Ngoài ra Thuốc Tím cũng có thể sử dụng định kì giúp diệt khuẩn, diệt tảo trong hồ cá và phòng bệnh cho cá

Khi thuốc tím hoạt tính (trong khi chưa oxy hóa), tan vào nước có mầu tím hồng. Một khi thuốc tím „mất hoạt tính” (đã oxy hoá các chất hữu cơ), mầu của dung dịch sẽ chuyển sang mầu vàng hoặc nâu vàng. Sự đổi mầu này rất có ích cho việc biểu thị ứng dụng hoá chất, và cho ta biết luôn là lúc này không nên sử dụng với những bể và hồ cá cảnh. Cũng như phần lớn các hoá chất khác, thuốc tím có hại đối với thực vật và động vật không có xương sống.', 'product_price'=>'30000', 'product_image'=>'thuoctim2.jpg', 'product_stock'=>'10', 'product_status' => '0'],
