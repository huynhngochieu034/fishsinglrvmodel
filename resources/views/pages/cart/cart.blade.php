...
<section id="cart_items">
		<div class="container container-responsive">
			...
			<h2 class="title text-center">Hàng đã đặt</h2>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<a class="cart_quantity_up" href="{{URL::to('/cart/update-quality/'.$cart->id.'/1')}}"> + </a>
									<input class="cart_quantity_input" type="text" name="quality" value="{{ $cart->quality }}" autocomplete="off" size="2">
									@if($cart->quality > 1)
									<a class="cart_quantity_down" href="{{URL::to('/cart/update-quality/'.$cart->id.'/-1')}}"> - </a>
									@endif
								</div>
							</td>
							<td class="cart_total">
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="{{ URL::to('/cart/delete-product/'.$cart->id) }}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
